function PrivacyPolicy() {
    ...
    document.body.style.color = "#3c4043"
    return (
        <div class="privacy-policy">
            <h1>PRIVACY POLICY</h1>
            <p>Last updated January 1, 2021</p>
            <p>Thank you for using Book Keeper. We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy policy, or our practices with regards to your personal information, please contact us at: blucozw@gmail.com. </p>
            <p>When you and more generally, use any of our services to sort and manage your transactions and other related services. We appreciate that you are trusting us with your information. We take your privacy very seriously. In this privacy policy, we seek to explain to you in the clearest way possible what information we collect, how we use it and what rights you have in relation to it. We hope you take some time to read through it carefully, as it is important. If there are any terms in this privacy policy that you do not agree with, please discontinue use of our services immediately. </p>
            <p>This privacy policy applies to all information collected through our services (which, as described above, includes Book Keeper), as well as, any related services, sales, marketing or events. </p>
            <p><b>Please read this privacy policy carefully as it will help you understand what we do with the information that we collect. </b></p>
            ...
            <p><b>Do we share, collect or store your SMSes or transactions  </b></p>
            <i><b>In Short:</b> No we do not share, collect, store your SMSes or transactions. This information is stored on your physical device and is not shared with anyone else. </i>
            <p>Book Keeper is intended to categorise or sort your EcoCash transactions on your physical device and no SMS or transaction is transferred to our servers or any third party.</p>
            <p><b>Information automatically collected</b></p>
            <i><b>In Short:</b> Some information — such as your Internet Protocol (IP) address and/or browser and device characteristics — is collected automatically when you use Book Keeper.</i>
            <p>We automatically collect certain information when you use Book Keeper. This information does not reveal your specific identity (like your name or contact information) but may include device and usage information, such as your IP address, browser and device characteristics, operating system, language preferences, referring URLs, device name, country, location, information about how and when you use Book Keeper and other technical information. This information is primarily needed to maintain the security and operation of our services, and for our internal analytics and reporting purposes.</p>
            ...
            <p>More specifically, we may need to process your data or share your data in the following situations:</p>
            ...
            <p>We may use cookies and similar tracking technologies (like web beacons and pixels) to access or store information. Specific information about how we use such technologies.</p>
            ...
            <p>Our servers location will change depending on your business needs. If you are accessing Book Keeper from inside or outside Zimbabwe, please be aware that your information may be transferred to, stored, and processed by us in our facilities and by those third parties with whom we may share your personal information (see "WILL YOUR INFORMATION BE SHARED WITH ANYONE?" above), in and other countries.</p>
            ...
            <p>We will only keep your information for as long as it is necessary for the purposes set out in this privacy policy, unless a longer retention period is required or permitted by law (such as tax, accounting or other legal requirements).</p>
            ...
            <p>If you have questions or comments about this policy, you may email us at: blucozw@gmail.com </p>
